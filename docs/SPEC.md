...
AGENTS.md          Consignes agnostiques pour Codex, Claude Code, Gemini CLI.
...
Le module Go doit vivre à la racine du repo.

Le code Go ne doit pas vivre dans `app/` pour le MVP.

L'entrée principale du binaire doit vivre dans :
...
À terme, l'annuaire pourra être enrichi par consultation de manuels, pages
`man`, Dash, Context7 ou MCP. Pas dans le MVP.
...
2. lire `README.md`, `AGENTS.md`, `PROJECT_STATE.md`, `TODO.md`,
   `docs/SPEC.md` ;
3. proposer ou mettre à jour une architecture ;
